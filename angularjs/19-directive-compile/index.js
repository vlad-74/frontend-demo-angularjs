...
console.log(gl_hr);
 let str = `
1. Compile используется для манипулирования самой разметкой нашего елемента и шаблона
2. <script src="https://cdnjs.cloudflare.com/ajax/libs/prettify/r298/prettify.js"></script>
3. <link rel="stylesheet" type="text/css" href="prettify.css">
`
 console.log(str + '\n' + gl_hr);
